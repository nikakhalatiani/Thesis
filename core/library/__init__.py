from .templates.compositional import *
from .templates.behavioral import *
from .templates.structural import *
from core.library.property_registry import PropertyRegistry
